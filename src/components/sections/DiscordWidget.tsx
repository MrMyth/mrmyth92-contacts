            ...
            <div className="space-y-2">
              ...
              <div className="p-4 rounded-xl bg-gray-100">
                <p className="text-gray-700">
				  ...
				  Если у вас проблемы с разблокировкой: сперва добавьтесь в публичную группу Telegram и я попробую вам помочь.
				  Это можно сделать с помощью кнопки "Telegram публичная группа" из прошлого раздела.
                </p>
              </div>
            </div>
