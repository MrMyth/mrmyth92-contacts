...
const DiscordWidget = () => {
  ...
  return <Card className="p-8 mb-8 border-0 shadow-lg bg-gradient-to-br from-gray-50 to-white">
      <motion.div initial={{
      opacity: 0,
      y: 10
    }} whileInView={{
          ...
          once: true
            ...
            <div className="space-y-2">
              ...
              <div className="p-4 rounded-xl bg-gray-100">
                <p className="text-gray-700">Чтобы зайти на сервер нажмите на "Зайти на сервер". Если приглашение не сработало, то используйте кнопку "Join Discord" в правом нижнем углу виджета. Если у вас проблемы с Discord, то как альтернативу вы можете использовать Telegram группу из прошлого раздела.</p>
              </div>
            </div>
