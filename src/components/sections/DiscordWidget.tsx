  ...
  return <Card className="p-6 mb-8 gaming-card">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <iframe src="https://discord.com/widget?id=835802952521351180&theme=light" width="100%" height="500" allowTransparency={true} frameBorder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts" className="rounded-lg border border-[#8B5CF6]/20" title="Discord Widget" loading="lazy"></iframe>
        </div>
        ...
        <div className="flex flex-col gap-6">
          <div>
            ...
            <p className="mb-4 text-primary-DEFAULT">Чтобы зайти на сервер нажмите на &quot;Зайти на сервер&quot;. Если приглашение не сработало, то используйте кнопку &quot;Join Discord&quot; Ее вы можете найти в правом нижнем углу виджета.</p>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-3 p-3 mt-3 rounded-lg bg-primary-foreground">
                ...
                <Button variant="outline" size="sm" onClick={handleCopyDiscordUsername} className="ml-auto bg-[#1B4D3E] hover:bg-[#1B4D3E]/90 text-white border-0" aria-label="Копировать Discord ник">
