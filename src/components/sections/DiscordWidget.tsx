  ...
  const socialLinks = [
    {
      ...
      bgColor: "bg-[#013220] hover:bg-[#013220]/90",
    },
    {
      ...
      >
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-blue-500 flex items-center justify-center gap-3">
            <svg className="h-8 w-8 text-[#013220]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <motion.div
              ...
              className="p-4 rounded-xl bg-gray-100 border border-gray-200 flex items-center gap-4"
            >
              <div>
              ...
              <Button 
                ...
                className="ml-auto bg-purple-600 hover:bg-green-700"
              >
