export const ru = {
  ...
  about: {
    ...
    warning2: "Для вашего удобства на сайте также есть кнопки на официальные сайты Telegram, WhatsApp и Discord. Это сделано для того, что вам не пришлось искать сайты этих программ.",
